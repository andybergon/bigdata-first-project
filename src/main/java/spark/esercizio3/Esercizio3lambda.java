...
//
//public class Esercizio3lambda implements Serializable {
//	private static final long serialVersionUID = 1L;
//
//	private static String pathToFileScontrini;
//	private static int rowsNumber;
//
//	public Esercizio3lambda(String fileScontrini) {
//		pathToFileScontrini = fileScontrini;
//	}
//
...
//
//		Esercizio3lambda wc = new Esercizio3lambda(args[0]);
...
//		JavaPairRDD<Tuple2<String, String>, Integer> ones = sc.textFile(pathToFileScontrini).flatMapToPair(rec -> {
...
//		JavaPairRDD<String, Tuple2<String, Integer>> result = counts
//				.mapToPair(s -> new Tuple2<>(s._1._1, new Tuple2<>(s._1._2, s._2)));
//		return result;
//	}
//
...
//
//		JavaPairRDD<String, String> result = join.mapToPair(s -> {
